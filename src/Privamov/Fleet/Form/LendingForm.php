...
class LendingForm extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('firstName', null, ['required' => true])
            ...
            ->add('started', 'date', ['required' => true])
            ->add('ended', 'date', ['required' => false])
            ->add('status', 'choice', ['choices' => ['lent' => 'lent', 'back' => 'back', 'lost' => 'lost']])
